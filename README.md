...
- `npm run build:html` copies `src/form-generator.html` into `dist/form-generator.html` and regenerates `src/embedded-html.js`, the runtime string that `mount()` renders.

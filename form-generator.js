var NFG=(()=>{var r=(e,n)=>()=>(n||e((n={exports:{}}).exports,n),n.exports);var i=r((u,s)=>{s.exports=`<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8"/>
...
`});var c=r((exports,module)=>{function loadHtml(){try{let e=i();if(typeof e=="string"&&e.indexOf("<script")!==-1)return e}catch(e){}try{let nodeRequire=eval('typeof require === "function" ? require : null');if(nodeRequire){let e=nodeRequire("fs"),n=nodeRequire("path");return e.readFileSync(n.join(__dirname,"form-generator.html"),"utf8")}}catch(e){}return""}var html=loadHtml();function mount(e,n){let a=n||{};if(typeof e=="string"&&(e=document.querySelector(e)),!e||typeof e.appendChild!="function")throw new Error("mount(): first argument must be a DOM element or a selector that resolves to one");if(!html)throw new Error("mount(): runtime HTML is unavailable \u2014 run `npm run build:html`");let o=html;if(Array.isArray(a.formConfig)){let p="<script>window.formConfig = "+JSON.stringify(a.formConfig).replace(/</g,"\\u003c")+";<\/script>";o=o.replace(/<head(\s[^>]*)?>/i,d=>d+p)}let l=e.ownerDocument||(typeof document<"u"?document:null);if(!l)throw new Error("mount(): no document available to create the iframe");let t=l.createElement("iframe");return t.setAttribute("title","Note Form Generator"),t.style.border="0",t.style.width="100%",t.style.height=a.height||"100%",t.srcdoc=o,e.innerHTML="",e.appendChild(t),t}module.exports={html,mount};module.exports.default=module.exports});return c();})();
